        ...
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4">
          <div className="bg-gray-800 rounded-lg max-w-md w-full p-6 shadow-xl">
            ...
            <p className="text-white mb-6">
              Are you sure you want to delete client <span className="text-amber-200 font-semibold">{clientName}</span>? 
              This will remove all their program enrollments as well. This action cannot be undone.
            </p>
